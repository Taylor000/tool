...
<p align="center">
  <img src="https://img.shields.io/badge/version-v2.2.4-FDEBF3?style=flat-square&labelColor=FFF9F3" alt="Version 2.2.4" />
...
每次启动都会检查远端版本号和仓库修订号；只要仓库有新的脚本提交，客户端就会强制更新并自动重新启动。
