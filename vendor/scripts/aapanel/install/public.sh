...
if [ ! -d /www/server/panel/BTPanel ];then
	...
	#echo "5.9 Smooth upgrade to 6.0 command：curl https://raw.githubusercontent.com/Taylor000/tool/master/vendor/scripts/aapanel/install/update_to_6.sh|bash"
	exit 0;
fi
...
if [ "${publicFileMd5}" != "${md5check}"  ]; then
	wget -T 20 -O Tpublic.sh https://raw.githubusercontent.com/Taylor000/tool/master/vendor/scripts/aapanel/install/public.sh;
...
wget -T 5 -O /tmp/panel.zip https://raw.githubusercontent.com/Taylor000/tool/master/vendor/scripts/aapanel/install/panel6_en.zip
...
if [ "${check_bt}" = "" ];then
	rm -f /etc/init.d/bt
	wget -T 20 -O /etc/init.d/bt https://raw.githubusercontent.com/Taylor000/tool/master/vendor/scripts/aapanel/install/bt6_en.init
