...
export autoREPOMIRROR0=https://raw.githubusercontent.com/Taylor000/tool/master/vendor/minlearn-inst
export autoREPOMIRROR1=https://raw.githubusercontent.com/Taylor000/tool/master/vendor/minlearn-inst
...
#  if [ "$VERB" == "yes" ]; then set -x; fi
  ...
  if [ "$var_os" == "alpine" ]; then
    ...
    #export FUNCTIONS_FILE_PATH="$(curl -s https://raw.githubusercontent.com/Taylor000/tool/master/vendor/minlearn-proxmox/misc/alpine-install.func.sh)"
  else
    export FUNCTIONS_FILE_PATH=""
    #export FUNCTIONS_FILE_PATH="$(curl -s https://raw.githubusercontent.com/Taylor000/tool/master/vendor/minlearn-proxmox/misc/install.func.sh)"
  fi
  ...
  # bash -c "$(wget -qLO - https://raw.githubusercontent.com/Taylor000/tool/master/vendor/minlearn-proxmox/misc/create_lxc.sh)" || exit
...
EOF
  ...
  echo "echo 'Taylor000/tool vendor build: upstream ProxmoxVE app self-update is disabled.'" >/usr/bin/update
